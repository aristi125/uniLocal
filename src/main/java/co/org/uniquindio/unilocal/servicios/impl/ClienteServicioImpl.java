...
public class ClienteServicioImpl implements ClienteServicio {
    ...
    public List<ItemListaLugaresDTO> listaLugaresCreados(String idCliente, String idNegocio) throws Exception {
        ...
        List<ItemListaLugaresDTO> respuesta = new ArrayList<>();
        ...
        for (Negocio n : historialNegocio) {
            respuesta.add(new ItemListaLugaresDTO(
                            n.getCodigo(),
                            n.getNombre(),
                            n.getTelefonos(),
    ...
    @Override
    public List<ItemListaLugaresDTO> buscarNegocioNombre(String nombre) throws Exception {

        List<Negocio> negocios = negocioRepo.findAll();
        List<ItemListaLugaresDTO> lugares = new ArrayList<>();
        if (negocios.isEmpty()) {
        ...
        for (Negocio n : negocios) {
            ...
            if (n.getNombre().toLowerCase().contains(nombre.toLowerCase()))
                lugares.add(new ItemListaLugaresDTO(
                                n.getCodigo(),
                                n.getNombre(),
                                n.getTelefonos(),
                                n.getCategoriaNegocio(),
    ...
    @Override
    public List<ItemListaLugaresDTO> buscarNegocioCategoria(Categoria categoria) throws Exception {
    ...
    @Override
    public List<ItemListaLugaresDTO> buscarNegocioDistancia(double distancia, Ubicacion ubicacionCliente) throws Exception {

        List<Negocio> negocios = negocioRepo.findAll();
        List<ItemListaLugaresDTO> lugaresCercanos = new ArrayList<>();
        ...
        for (Negocio negocio : negocios) {
            ...
            if (distanciaCalculada <= distancia) {
                ...
                lugaresCercanos.add(new ItemListaLugaresDTO(
                        negocio.getCodigo(),
                        negocio.getNombre(),
    ...
    @Override
    public List<ItemListaLugaresDTO> recomendarNegocio(String busqueda) throws Exception {
